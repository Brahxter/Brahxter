...
class WhimsicalToRealWallet:
    ...
    def __init__(self):
        ...
        self.client = coinbase.wallet.client.Client(api_key='3c0f8e2c-50c2-462a-b0fb-ff02e8b45331/apiKeys/7caa9d5f-f34c-4dde-be95-5409a7d94fe6', api_secret='EW2ucn5rr0WZ/qY0nwrk/6uxCtkBdESSpw==')
